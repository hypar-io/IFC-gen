...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class VibrationIsolatorType : ElementComponentType 
	{
		public VibrationIsolatorTypeEnum PredefinedType {get;set;}

		public VibrationIsolatorType(VibrationIsolatorTypeEnum predefinedType,
				String elementType,
