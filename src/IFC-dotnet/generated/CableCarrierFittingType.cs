...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class CableCarrierFittingType : FlowFittingType 
	{
		public CableCarrierFittingTypeEnum PredefinedType {get;set;}

		public CableCarrierFittingType(CableCarrierFittingTypeEnum predefinedType,
				String elementType,
