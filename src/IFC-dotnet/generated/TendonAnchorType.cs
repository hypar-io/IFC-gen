...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class TendonAnchorType : ReinforcingElementType 
	{
		public TendonAnchorTypeEnum PredefinedType {get;set;}

		public TendonAnchorType(TendonAnchorTypeEnum predefinedType,
				String elementType,
