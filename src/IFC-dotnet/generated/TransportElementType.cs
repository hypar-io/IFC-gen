...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class TransportElementType : ElementType 
	{
		public TransportElementTypeEnum PredefinedType {get;set;}

		public TransportElementType(TransportElementTypeEnum predefinedType,
				String elementType,
