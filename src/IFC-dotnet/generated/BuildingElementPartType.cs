...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class BuildingElementPartType : ElementComponentType 
	{
		public BuildingElementPartTypeEnum PredefinedType {get;set;}

		public BuildingElementPartType(BuildingElementPartTypeEnum predefinedType,
				String elementType,
