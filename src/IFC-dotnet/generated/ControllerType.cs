...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class ControllerType : DistributionControlElementType 
	{
		public ControllerTypeEnum PredefinedType {get;set;}

		public ControllerType(ControllerTypeEnum predefinedType,
				String elementType,
