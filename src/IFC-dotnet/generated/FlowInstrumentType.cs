...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class FlowInstrumentType : DistributionControlElementType 
	{
		public FlowInstrumentTypeEnum PredefinedType {get;set;}

		public FlowInstrumentType(FlowInstrumentTypeEnum predefinedType,
				String elementType,
