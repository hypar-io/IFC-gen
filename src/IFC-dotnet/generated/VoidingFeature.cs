...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class VoidingFeature : FeatureElementSubtraction 
	{
		public VoidingFeatureTypeEnum PredefinedType {get;set;}

		public VoidingFeature(VoidingFeatureTypeEnum predefinedType,
