...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class CableCarrierSegmentType : FlowSegmentType 
	{
		public CableCarrierSegmentTypeEnum PredefinedType {get;set;}

		public CableCarrierSegmentType(CableCarrierSegmentTypeEnum predefinedType,
				String elementType,
