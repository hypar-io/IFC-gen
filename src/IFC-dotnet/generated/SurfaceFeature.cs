...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class SurfaceFeature : FeatureElement 
	{
		public SurfaceFeatureTypeEnum PredefinedType {get;set;}

		public SurfaceFeature(SurfaceFeatureTypeEnum predefinedType,
