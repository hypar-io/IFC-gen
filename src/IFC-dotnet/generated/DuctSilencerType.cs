...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class DuctSilencerType : FlowTreatmentDeviceType 
	{
		public DuctSilencerTypeEnum PredefinedType {get;set;}

		public DuctSilencerType(DuctSilencerTypeEnum predefinedType,
				String elementType,
