...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class CommunicationsApplianceType : FlowTerminalType 
	{
		public CommunicationsApplianceTypeEnum PredefinedType {get;set;}

		public CommunicationsApplianceType(CommunicationsApplianceTypeEnum predefinedType,
				String elementType,
