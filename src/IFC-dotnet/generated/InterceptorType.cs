...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class InterceptorType : FlowTreatmentDeviceType 
	{
		public InterceptorTypeEnum PredefinedType {get;set;}

		public InterceptorType(InterceptorTypeEnum predefinedType,
				String elementType,
