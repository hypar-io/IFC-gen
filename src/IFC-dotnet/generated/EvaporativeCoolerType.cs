...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class EvaporativeCoolerType : EnergyConversionDeviceType 
	{
		public EvaporativeCoolerTypeEnum PredefinedType {get;set;}

		public EvaporativeCoolerType(EvaporativeCoolerTypeEnum predefinedType,
				String elementType,
