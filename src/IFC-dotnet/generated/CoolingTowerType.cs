...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class CoolingTowerType : EnergyConversionDeviceType 
	{
		public CoolingTowerTypeEnum PredefinedType {get;set;}

		public CoolingTowerType(CoolingTowerTypeEnum predefinedType,
				String elementType,
