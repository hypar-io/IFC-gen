...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class FastenerType : ElementComponentType 
	{
		public FastenerTypeEnum PredefinedType {get;set;}

		public FastenerType(FastenerTypeEnum predefinedType,
				String elementType,
