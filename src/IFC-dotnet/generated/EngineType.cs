...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class EngineType : EnergyConversionDeviceType 
	{
		public EngineTypeEnum PredefinedType {get;set;}

		public EngineType(EngineTypeEnum predefinedType,
				String elementType,
