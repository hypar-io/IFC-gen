...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class DistributionChamberElementType : DistributionFlowElementType 
	{
		public DistributionChamberElementTypeEnum PredefinedType {get;set;}

		public DistributionChamberElementType(DistributionChamberElementTypeEnum predefinedType,
				String elementType,
