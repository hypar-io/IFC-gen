...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class SystemFurnitureElementType : FurnishingElementType 
	{
		public SystemFurnitureElementTypeEnum PredefinedType {get;set;}

		public SystemFurnitureElementType(SystemFurnitureElementTypeEnum predefinedType,
				String elementType,
