...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class SensorType : DistributionControlElementType 
	{
		public SensorTypeEnum PredefinedType {get;set;}

		public SensorType(SensorTypeEnum predefinedType,
				String elementType,
