...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class ProtectiveDeviceType : FlowControllerType 
	{
		public ProtectiveDeviceTypeEnum PredefinedType {get;set;}

		public ProtectiveDeviceType(ProtectiveDeviceTypeEnum predefinedType,
				String elementType,
