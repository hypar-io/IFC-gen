...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class FireSuppressionTerminalType : FlowTerminalType 
	{
		public FireSuppressionTerminalTypeEnum PredefinedType {get;set;}

		public FireSuppressionTerminalType(FireSuppressionTerminalTypeEnum predefinedType,
				String elementType,
