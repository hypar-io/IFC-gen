...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class SanitaryTerminalType : FlowTerminalType 
	{
		public SanitaryTerminalTypeEnum PredefinedType {get;set;}

		public SanitaryTerminalType(SanitaryTerminalTypeEnum predefinedType,
				String elementType,
