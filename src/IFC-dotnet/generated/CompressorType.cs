...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class CompressorType : FlowMovingDeviceType 
	{
		public CompressorTypeEnum PredefinedType {get;set;}

		public CompressorType(CompressorTypeEnum predefinedType,
				String elementType,
