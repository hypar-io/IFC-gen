...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class UnitaryControlElementType : DistributionControlElementType 
	{
		public UnitaryControlElementTypeEnum PredefinedType {get;set;}

		public UnitaryControlElementType(UnitaryControlElementTypeEnum predefinedType,
				String elementType,
