...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class CurtainWallType : BuildingElementType 
	{
		public CurtainWallTypeEnum PredefinedType {get;set;}

		public CurtainWallType(CurtainWallTypeEnum predefinedType,
				String elementType,
