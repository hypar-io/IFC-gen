...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class MedicalDeviceType : FlowTerminalType 
	{
		public MedicalDeviceTypeEnum PredefinedType {get;set;}

		public MedicalDeviceType(MedicalDeviceTypeEnum predefinedType,
				String elementType,
