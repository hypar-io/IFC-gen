...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class RampFlightType : BuildingElementType 
	{
		public RampFlightTypeEnum PredefinedType {get;set;}

		public RampFlightType(RampFlightTypeEnum predefinedType,
				String elementType,
