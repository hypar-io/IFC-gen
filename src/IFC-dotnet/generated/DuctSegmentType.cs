...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class DuctSegmentType : FlowSegmentType 
	{
		public DuctSegmentTypeEnum PredefinedType {get;set;}

		public DuctSegmentType(DuctSegmentTypeEnum predefinedType,
				String elementType,
