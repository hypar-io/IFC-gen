...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class WasteTerminalType : FlowTerminalType 
	{
		public WasteTerminalTypeEnum PredefinedType {get;set;}

		public WasteTerminalType(WasteTerminalTypeEnum predefinedType,
				String elementType,
