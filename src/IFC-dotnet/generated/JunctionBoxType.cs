...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class JunctionBoxType : FlowFittingType 
	{
		public JunctionBoxTypeEnum PredefinedType {get;set;}

		public JunctionBoxType(JunctionBoxTypeEnum predefinedType,
				String elementType,
