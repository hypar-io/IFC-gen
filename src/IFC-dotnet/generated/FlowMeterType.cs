...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class FlowMeterType : FlowControllerType 
	{
		public FlowMeterTypeEnum PredefinedType {get;set;}

		public FlowMeterType(FlowMeterTypeEnum predefinedType,
				String elementType,
