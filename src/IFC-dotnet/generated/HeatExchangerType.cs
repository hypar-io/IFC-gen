...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class HeatExchangerType : EnergyConversionDeviceType 
	{
		public HeatExchangerTypeEnum PredefinedType {get;set;}

		public HeatExchangerType(HeatExchangerTypeEnum predefinedType,
				String elementType,
