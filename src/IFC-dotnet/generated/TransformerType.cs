...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class TransformerType : EnergyConversionDeviceType 
	{
		public TransformerTypeEnum PredefinedType {get;set;}

		public TransformerType(TransformerTypeEnum predefinedType,
				String elementType,
