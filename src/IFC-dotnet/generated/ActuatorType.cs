...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class ActuatorType : DistributionControlElementType 
	{
		public ActuatorTypeEnum PredefinedType {get;set;}

		public ActuatorType(ActuatorTypeEnum predefinedType,
				String elementType,
