...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class DiscreteAccessoryType : ElementComponentType 
	{
		public DiscreteAccessoryTypeEnum PredefinedType {get;set;}

		public DiscreteAccessoryType(DiscreteAccessoryTypeEnum predefinedType,
				String elementType,
