...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class ElectricDistributionBoardType : FlowControllerType 
	{
		public ElectricDistributionBoardTypeEnum PredefinedType {get;set;}

		public ElectricDistributionBoardType(ElectricDistributionBoardTypeEnum predefinedType,
				String elementType,
