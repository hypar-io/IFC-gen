...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class CooledBeamType : EnergyConversionDeviceType 
	{
		public CooledBeamTypeEnum PredefinedType {get;set;}

		public CooledBeamType(CooledBeamTypeEnum predefinedType,
				String elementType,
