...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class ProtectiveDeviceTrippingUnitType : DistributionControlElementType 
	{
		public ProtectiveDeviceTrippingUnitTypeEnum PredefinedType {get;set;}

		public ProtectiveDeviceTrippingUnitType(ProtectiveDeviceTrippingUnitTypeEnum predefinedType,
				String elementType,
