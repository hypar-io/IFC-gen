...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class OpeningStandardCase : OpeningElement 
	{


		public OpeningStandardCase(RelFillsElement hasFillings,
				...
				ObjectDefinitionIsDecomposedBy isDecomposedBy) : base(hasFillings,
				predefinedType,
				hasProjections,
				hasOpenings,
				tag,
