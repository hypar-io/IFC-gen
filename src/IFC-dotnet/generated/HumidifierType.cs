...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class HumidifierType : EnergyConversionDeviceType 
	{
		public HumidifierTypeEnum PredefinedType {get;set;}

		public HumidifierType(HumidifierTypeEnum predefinedType,
				String elementType,
