...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class ElectricGeneratorType : EnergyConversionDeviceType 
	{
		public ElectricGeneratorTypeEnum PredefinedType {get;set;}

		public ElectricGeneratorType(ElectricGeneratorTypeEnum predefinedType,
				String elementType,
