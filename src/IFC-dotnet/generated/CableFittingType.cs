...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class CableFittingType : FlowFittingType 
	{
		public CableFittingTypeEnum PredefinedType {get;set;}

		public CableFittingType(CableFittingTypeEnum predefinedType,
				String elementType,
