...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class AlarmType : DistributionControlElementType 
	{
		public AlarmTypeEnum PredefinedType {get;set;}

		public AlarmType(AlarmTypeEnum predefinedType,
				String elementType,
