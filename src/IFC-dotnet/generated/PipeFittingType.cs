...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class PipeFittingType : FlowFittingType 
	{
		public PipeFittingTypeEnum PredefinedType {get;set;}

		public PipeFittingType(PipeFittingTypeEnum predefinedType,
				String elementType,
