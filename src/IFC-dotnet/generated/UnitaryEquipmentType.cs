...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class UnitaryEquipmentType : EnergyConversionDeviceType 
	{
		public UnitaryEquipmentTypeEnum PredefinedType {get;set;}

		public UnitaryEquipmentType(UnitaryEquipmentTypeEnum predefinedType,
				String elementType,
