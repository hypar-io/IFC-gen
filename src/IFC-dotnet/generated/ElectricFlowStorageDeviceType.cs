...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class ElectricFlowStorageDeviceType : FlowStorageDeviceType 
	{
		public ElectricFlowStorageDeviceTypeEnum PredefinedType {get;set;}

		public ElectricFlowStorageDeviceType(ElectricFlowStorageDeviceTypeEnum predefinedType,
				String elementType,
