...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class ChillerType : EnergyConversionDeviceType 
	{
		public ChillerTypeEnum PredefinedType {get;set;}

		public ChillerType(ChillerTypeEnum predefinedType,
				String elementType,
