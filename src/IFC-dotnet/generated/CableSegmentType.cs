...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class CableSegmentType : FlowSegmentType 
	{
		public CableSegmentTypeEnum PredefinedType {get;set;}

		public CableSegmentType(CableSegmentTypeEnum predefinedType,
				String elementType,
