...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class AirTerminalType : FlowTerminalType 
	{
		public AirTerminalTypeEnum PredefinedType {get;set;}

		public AirTerminalType(AirTerminalTypeEnum predefinedType,
				String elementType,
