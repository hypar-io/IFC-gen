...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class GeographicElementType : ElementType 
	{
		public GeographicElementTypeEnum PredefinedType {get;set;}

		public GeographicElementType(GeographicElementTypeEnum predefinedType,
				String elementType,
