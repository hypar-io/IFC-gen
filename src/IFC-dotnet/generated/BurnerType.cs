...
namespace IFC4
{
	...
	/// </summary>
	internal  partial class BurnerType : EnergyConversionDeviceType 
	{
		public BurnerTypeEnum PredefinedType {get;set;}

		public BurnerType(BurnerTypeEnum predefinedType,
				String elementType,
