...
import {IfcUnitaryEquipmentTypeEnum} from "./IfcUnitaryEquipmentTypeEnum.g"
...
export class IfcUnitaryEquipmentType extends IfcEnergyConversionDeviceType {
    ...
    constructor(globalId : IfcGloballyUniqueId, predefinedType : IfcUnitaryEquipmentTypeEnum) {
        super(globalId)
