...
import {IfcPileTypeEnum} from "./IfcPileTypeEnum.g"
import {IfcPileConstructionEnum} from "./IfcPileConstructionEnum.g"
...
export class IfcPile extends IfcBuildingElement {
	PredefinedType : IfcPileTypeEnum // optional
	ConstructionType : IfcPileConstructionEnum // optional
