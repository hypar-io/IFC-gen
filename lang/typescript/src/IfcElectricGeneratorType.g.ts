...
import {IfcElectricGeneratorTypeEnum} from "./IfcElectricGeneratorTypeEnum.g"
...
export class IfcElectricGeneratorType extends IfcEnergyConversionDeviceType {
    ...
    constructor(globalId : IfcGloballyUniqueId, predefinedType : IfcElectricGeneratorTypeEnum) {
        super(globalId)
