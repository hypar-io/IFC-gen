...
import {IfcCableCarrierSegmentTypeEnum} from "./IfcCableCarrierSegmentTypeEnum.g"
...
export class IfcCableCarrierSegmentType extends IfcFlowSegmentType {
    ...
    constructor(globalId : IfcGloballyUniqueId, predefinedType : IfcCableCarrierSegmentTypeEnum) {
        super(globalId)
