...
import {IfcVibrationIsolatorTypeEnum} from "./IfcVibrationIsolatorTypeEnum.g"
...
export class IfcVibrationIsolatorType extends IfcElementComponentType {
    ...
    constructor(globalId : IfcGloballyUniqueId, predefinedType : IfcVibrationIsolatorTypeEnum) {
        super(globalId)
