...
import {IfcBuildingElementPartTypeEnum} from "./IfcBuildingElementPartTypeEnum.g"
...
export class IfcBuildingElementPartType extends IfcElementComponentType {
    ...
    constructor(globalId : IfcGloballyUniqueId, predefinedType : IfcBuildingElementPartTypeEnum) {
        super(globalId)
