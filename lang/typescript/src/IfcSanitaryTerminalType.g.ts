...
import {IfcSanitaryTerminalTypeEnum} from "./IfcSanitaryTerminalTypeEnum.g"
...
export class IfcSanitaryTerminalType extends IfcFlowTerminalType {
    ...
    constructor(globalId : IfcGloballyUniqueId, predefinedType : IfcSanitaryTerminalTypeEnum) {
        super(globalId)
