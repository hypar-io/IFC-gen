...
import {IfcEvaporativeCoolerTypeEnum} from "./IfcEvaporativeCoolerTypeEnum.g"
...
export class IfcEvaporativeCoolerType extends IfcEnergyConversionDeviceType {
    ...
    constructor(globalId : IfcGloballyUniqueId, predefinedType : IfcEvaporativeCoolerTypeEnum) {
        super(globalId)
