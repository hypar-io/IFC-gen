...
export class IfcSectionedSpine extends IfcGeometricRepresentationItem {
    ...
    getStepParameters() : string {
		...
		parameters.push(this.SpineCurve != null ? BaseIfc.toStepValue(this.SpineCurve) : "$");
		parameters.push(this.CrossSections != null ? BaseIfc.toStepValue(this.CrossSections) : "$");
		parameters.push(this.CrossSectionPositions != null ? BaseIfc.toStepValue(this.CrossSectionPositions) : "$");
