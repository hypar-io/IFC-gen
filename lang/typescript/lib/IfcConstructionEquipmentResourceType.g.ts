...
import {IfcConstructionEquipmentResourceTypeEnum} from "./IfcConstructionEquipmentResourceTypeEnum"
...
export class IfcConstructionEquipmentResourceType extends IfcConstructionResourceType {
    ...
    constructor(globalId : IfcGloballyUniqueId, predefinedType : IfcConstructionEquipmentResourceTypeEnum) {
        super(globalId)
