...
import {IfcFlowInstrumentTypeEnum} from "./IfcFlowInstrumentTypeEnum"
import {IfcDistributionControlElementType} from "./IfcDistributionControlElementType"
...
export class IfcFlowInstrumentType extends IfcDistributionControlElementType {
    ...
    constructor(globalId : IfcGloballyUniqueId, predefinedType : IfcFlowInstrumentTypeEnum) {
        super(globalId)
